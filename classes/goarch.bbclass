...
HOST_GO386 = "${@go_map_386(d.getVar('HOST_ARCH', True), d.getVar('TUNE_FEATURES', True), d)}"
HOST_GOMIPS = "${@go_map_mips(d.getVar('HOST_ARCH', True), d.getVar('TUNE_FEATURES', True), d)}"
...
TARGET_GO386 = "${@go_map_386(d.getVar('TARGET_ARCH', True), d.getVar('TUNE_FEATURES', True), d)}"
TARGET_GOMIPS = "${@go_map_mips(d.getVar('TARGET_ARCH', True), d.getVar('TUNE_FEATURES', True), d)}"
